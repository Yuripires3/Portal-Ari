...
export const ALIASES_POR_INDICADOR: Record<IndicadorKey, string[]> = {
  ...
  exclusao_dependente: ["exclusao_dependente", "exclusao_de_dependente"],
  falecimento: ["falecimento", "obito"],
  outros: ["outros"],
  migracao_assim_assim: ["migracao_assim_assim"],
  migracao_assim_outras: ["migracao_assim_outras"],
  migracao_caberj_assim: ["migracao_caberj_assim"],
  migracao_caberj_outras: ["migracao_caberj_outras"],
  total_migracao: ["total_migracao"],
  cancelamento_liquido: ["cancelamento_liquido"],
  faturamento_orcado: ["faturamento_orcado"],
